...
e-Greedy: The person will have a variation between exploration and exploitation. The value of e will determine what percentage of visits the person will choose to explore instead of exploit. e-Greedy can provide an optimal level of hapiness by adding a slight variation to the choice of where to eat. Although the food-place might be the best and have the highest average hapiness, eating the same thing over and over will get boring and decline in satisfaction.
